...
public class Paths {
    ...
    public static XMLdigger digInSettings() {
        return XMLdigger.goIn(Paths.settings(), "meles");
    }
    public static XMLdigger digInSettings( String sub ){
        return XMLdigger.goIn(Paths.settings(), "meles", sub);
    }
    public static XMLfab fabInSettings( String sub ){
        if (sub.isEmpty())
            return XMLfab.withRoot(Paths.settings(), "meles");
        return XMLfab.withRoot(Paths.settings(), "meles", sub);
    }
